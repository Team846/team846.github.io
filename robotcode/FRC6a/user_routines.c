...
void Default_Routine(void)
{
	...
	robot_feedback_led robot_feedback_led;
	robot_feedback_led.led_c = (unsigned char) (led >> 5);
	led++;
  ...
  */	
  ...
  if (user_display_mode == 0) /* User Mode is Off */
	...
	{
		Pwm1_green = 	robot_feedback_led.led_s.bit0;
		Pwm1_red = 	robot_feedback_led.led_s.bit1;
		Pwm2_green = 	robot_feedback_led.led_s.bit2;
		Pwm2_red = 	robot_feedback_led.led_s.bit3;
		Relay1_green = robot_feedback_led.led_s.bit4;
		Relay1_red = robot_feedback_led.led_s.bit5;
		Relay2_green = robot_feedback_led.led_s.bit6;
		Relay2_red = robot_feedback_led.led_s.bit7;	
