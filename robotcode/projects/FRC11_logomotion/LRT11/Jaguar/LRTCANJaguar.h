#ifndef LRT_CAN_JAGUAR_H
#define LRT_CAN_JAGUAR_H
 ...
 */
class LRTCANJaguar : public MotorSafety, public PIDOutput, public SpeedController
{
public:
    ...
    explicit LRTCANJaguar(UINT8 deviceNumber, ControlMode controlMode = kPercentVbus);
    virtual ~LRTCANJaguar();
