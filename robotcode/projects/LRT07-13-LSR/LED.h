...
union  OI_LEDs{
	...
	struct {
		unsigned RightPx1 :1;		//0 Pwm1_green;
		unsigned LeftPx1:1;			//1 Pwm1_red;
		unsigned RightPx2:1;		//2 Pwm1_green;
		unsigned LeftPx2:1;			//3 Pwm2_red;
		unsigned LeftPx3:1;			//4 Relay1_red
		unsigned RightPx3:1;		//5 Relay1_green
		unsigned LeftPx4:1;			//6 Relay2_red
		unsigned RightPx4:1;		//7 Relay2_green
		//-- second byte
		unsigned BumperPx1			:1;		//0 Switch1_LED
		unsigned BumperPx2			:1;		//1 Switch2_LED
		unsigned BumperPx3			:1;		//2 Switch3_LED
		unsigned :5;	//unused.
	};
};
