...
****************************************************************
   ...
   *** "Bells and Whistles" version of the tracking code ***
...
range to the colored object. The "Bells and Whistles" version 
of the software adds the ability to change operating parameters
on-the-fly using a menu system presented on your terminal 
screen.
...
Here's a description of the functions in tracking.c:
...
Initialize_Tracking()
This function is responsable for initializing the tracking
software.


Get_Tracking_Configuration()
This function initializes the Tracking_Config_Data structure 
with data stored in EEPROM. If valid data isn't present in 
EEPROM or the force_default flag is set, default values from 
